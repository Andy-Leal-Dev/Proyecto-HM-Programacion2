...
Router.get('/SearchPaciente/:dni', authMiddleware, viewController.searchPaciente) //Vista de Paciente buscado. este pide un DNi(Cedula) por parametro para su busqueda
