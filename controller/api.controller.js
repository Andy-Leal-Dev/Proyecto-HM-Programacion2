...
class Api {
    ...
    addNewPaciente(req,res){
        //Le pido al usuario los siguientes datos. Mediante el body en formato JSOn
         const{tipo,Nombres,Apellidos,Cedula,Edad,Telefono,Ocupacion,Direccion_Completa,Informacion_Adicional,Emergencia,Parentesco,Telefono_Parentesco,Direccion_Parentesco,Pediatrico_Nombres,Pediatrico_Apellidos,Pediatrico_Edad,Pediatrico_Cedula,Pediatrico_Sexo}= req.body
         ...
         .then(responsePaciente=>{
             res.status(200)//Si se crea eniara un estatus 200 al ejs.
         })
         .catch(err => {
